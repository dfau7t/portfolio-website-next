...
export default async function Video(props: any) {
    return (
        <div className="frame grid grid-cols-1 grid-rows-3 md:grid-cols-3 md:grid-rows-3 mx-5 my-2.5 p-2.5 gap-2.5 h-[95vh]">
            <div className="col-span-1 row-span-1 md:col-span-1 md:row-span-2 frame overflow-clip">
                <Image 
                    src={props.img}
                    alt="file"
                />
